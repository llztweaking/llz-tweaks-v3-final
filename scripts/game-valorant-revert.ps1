...
$targetName = "VALORANT-Win64-Shipping.exe"
$removed = $false
...
if ($removed) {
  Write-Output "Otimizações do Valorant removidas: GPU dedicada e ajuste de tela cheia revertidos.$priorityWarning"
} else {
  Write-Output "Nenhuma otimização específica do Valorant encontrada para remover.$priorityWarning"
}
