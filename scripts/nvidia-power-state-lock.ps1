...
if (-not (Test-Path $ftsPath)) { New-Item -Path $ftsPath -Force | Out-Null }
Set-ItemProperty -Path $ftsPath -Name "EnableGR535" -Value 0 -Type DWord -Force
Write-Output "Estado de energia da GPU NVIDIA travado em desempenho máximo durante jogos."
