...
$targetName = "FortniteClient-Win64-Shipping.exe"
$removed = $false
...
if ($removed) {
  Write-Output "Otimizações do Fortnite removidas: GPU dedicada e ajuste de tela cheia revertidos.$priorityWarning"
} else {
  Write-Output "Nenhuma otimização específica do Fortnite encontrada para remover.$priorityWarning"
}
